...
namespace grp_management.Migrations
{
    ...
    [Migration("20250625150843_AddMoreSeedTemplates")]
    partial class AddMoreSeedTemplates
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("grp_management.Models.Contact", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = -1,
                            AccessLevel = "Admin",
                            AddedAt = new DateTime(2025, 6, 25, 15, 8, 42, 493, DateTimeKind.Utc).AddTicks(4953),
                            EmployeeId = -1,
                            GroupId = -1,
                            UserId = -1,
                            UserName = "testuser1"
                        ...
                        new
                        {
                            Id = -2,
                            AccessLevel = "Member",
                            AddedAt = new DateTime(2025, 6, 25, 15, 8, 42, 493, DateTimeKind.Utc).AddTicks(4957),
                            EmployeeId = -2,
                            GroupId = -2,
                            UserId = -2,
                            UserName = "testuser2"
            ...
            modelBuilder.Entity("grp_management.Models.Employee", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            EmpNO = -1,
                            CreatedAt = new DateTime(2025, 6, 25, 15, 8, 41, 850, DateTimeKind.Utc).AddTicks(2451),
                            Department = "IT",
                        ...
                        {
                            EmpNO = -2,
                            CreatedAt = new DateTime(2025, 6, 25, 15, 8, 41, 850, DateTimeKind.Utc).AddTicks(2454),
                            Department = "HR",
            ...
            modelBuilder.Entity("grp_management.Models.Group", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = -1,
                            CreatedAt = new DateTime(2025, 6, 25, 15, 8, 41, 850, DateTimeKind.Utc).AddTicks(2697),
                        ...
                        {
                            Id = -2,
                            CreatedAt = new DateTime(2025, 6, 25, 15, 8, 41, 850, DateTimeKind.Utc).AddTicks(2701),
            ...
            modelBuilder.Entity("grp_management.Models.GroupMembershipRequest", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EmployeeId = -1,
                            GroupId = -1,
                            RequestDate = new DateTime(2025, 6, 24, 15, 8, 41, 850, DateTimeKind.Utc).AddTicks(2733),
                            Status = "Pending"
                        },
                        new
                        {
                            ...
                            EmployeeId = -2,
                            GroupId = -2,
                            RequestDate = new DateTime(2025, 6, 25, 15, 8, 41, 850, DateTimeKind.Utc).AddTicks(2742),
                            Status = "Pending"
                        },
                        new
                        {
                            ...
                            EmployeeId = -2,
                            GroupId = -1,
                            ProcessedDate = new DateTime(2025, 6, 24, 15, 8, 41, 850, DateTimeKind.Utc).AddTicks(2745),
                            RequestDate = new DateTime(2025, 6, 23, 15, 8, 41, 850, DateTimeKind.Utc).AddTicks(2744),
                            Status = "Approved"
                        },
                        new
                        {
                            ...
                            EmployeeId = -1,
                            GroupId = -2,
                            ProcessedDate = new DateTime(2025, 6, 23, 15, 8, 41, 850, DateTimeKind.Utc).AddTicks(2757),
                            RequestDate = new DateTime(2025, 6, 22, 15, 8, 41, 850, DateTimeKind.Utc).AddTicks(2756),
                            Status = "Rejected"
                        });
                });
            ...
            modelBuilder.Entity("grp_management.Models.SentMsg", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            SenderEmployeeId = -1,
                            SentDate = new DateTime(2025, 6, 25, 5, 8, 42, 493, DateTimeKind.Utc).AddTicks(5177),
                            SentVia = "WebApp",
                            Status = "Sent",
                            TemplateID = -1,
                            VariablesJson = "{}"
                        ...
                        new
                        {
                            ...
                            SenderEmployeeId = -2,
                            SentDate = new DateTime(2025, 6, 25, 10, 8, 42, 493, DateTimeKind.Utc).AddTicks(5192),
                            SentVia = "WebApp",
                            Status = "Sent",
                            TemplateID = -2,
                            VariablesJson = "{}"
            ...
            modelBuilder.Entity("grp_management.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = -1,
                            CreatedAt = new DateTime(2025, 6, 25, 15, 8, 42, 170, DateTimeKind.Utc).AddTicks(4052),
                            Email = "admin@example.com",
                            PasswordHash = "$2a$12$65YoOElI2vWZRxSf6XT1Lu/Ep3OE9a8YCVZ.CVF9vC6S4FoZ3ukLG",
                            Role = "Admin",
                            Username = "admin"
                        },
                        new
                        {
                            Id = -2,
                            CreatedAt = new DateTime(2025, 6, 25, 15, 8, 42, 493, DateTimeKind.Utc).AddTicks(3981),
                            Email = "user@example.com",
                            PasswordHash = "$2a$12$7WNKH6swUAOzbLFGb4.21uL8o8OyGnhO9H/.OcUYbt1ZcY7Z42Cri",
                            Role = "User",
                            Username = "user"
                        });
                });
