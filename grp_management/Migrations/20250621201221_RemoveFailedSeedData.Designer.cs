...
namespace grp_management.Migrations
{
    ...
    [Migration("20250621201221_RemoveFailedSeedData")]
    partial class RemoveFailedSeedData
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("grp_management.Models.Contact", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = -1,
                            AccessLevel = "Admin",
                            AddedAt = new DateTime(2025, 6, 21, 20, 12, 20, 733, DateTimeKind.Utc).AddTicks(2175),
                            EmployeeId = -1,
                            GroupId = -1,
                            UserId = -1,
                            UserName = "testuser1"
                        ...
                        new
                        {
                            Id = -2,
                            AccessLevel = "Member",
                            AddedAt = new DateTime(2025, 6, 21, 20, 12, 20, 733, DateTimeKind.Utc).AddTicks(2181),
                            EmployeeId = -2,
                            GroupId = -2,
                            UserId = -2,
                            UserName = "testuser2"
            ...
            modelBuilder.Entity("grp_management.Models.Employee", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            EmpNO = -1,
                            CreatedAt = new DateTime(2025, 6, 21, 20, 12, 19, 760, DateTimeKind.Utc).AddTicks(5504),
                            Department = "IT",
                        ...
                        {
                            EmpNO = -2,
                            CreatedAt = new DateTime(2025, 6, 21, 20, 12, 19, 760, DateTimeKind.Utc).AddTicks(5507),
                            Department = "HR",
            ...
            modelBuilder.Entity("grp_management.Models.Group", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = -1,
                            CreatedAt = new DateTime(2025, 6, 21, 20, 12, 19, 760, DateTimeKind.Utc).AddTicks(5792),
                        ...
                        {
                            Id = -2,
                            CreatedAt = new DateTime(2025, 6, 21, 20, 12, 19, 760, DateTimeKind.Utc).AddTicks(5797),
            ...
            modelBuilder.Entity("grp_management.Models.GroupMembershipRequest", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EmployeeId = -1,
                            GroupId = -1,
                            RequestDate = new DateTime(2025, 6, 20, 20, 12, 19, 760, DateTimeKind.Utc).AddTicks(5839),
                            Status = "Pending"
                        },
                        new
                        {
                            ...
                            EmployeeId = -2,
                            GroupId = -2,
                            RequestDate = new DateTime(2025, 6, 21, 20, 12, 19, 760, DateTimeKind.Utc).AddTicks(5848),
                            Status = "Pending"
                        },
                        new
                        {
                            ...
                            EmployeeId = -2,
                            GroupId = -1,
                            ProcessedDate = new DateTime(2025, 6, 20, 20, 12, 19, 760, DateTimeKind.Utc).AddTicks(5852),
                            RequestDate = new DateTime(2025, 6, 19, 20, 12, 19, 760, DateTimeKind.Utc).AddTicks(5851),
                            Status = "Approved"
                        },
                        new
                        {
                            ...
                            EmployeeId = -1,
                            GroupId = -2,
                            ProcessedDate = new DateTime(2025, 6, 19, 20, 12, 19, 760, DateTimeKind.Utc).AddTicks(5869),
                            RequestDate = new DateTime(2025, 6, 18, 20, 12, 19, 760, DateTimeKind.Utc).AddTicks(5868),
                            Status = "Rejected"
                        });
                });
            ...
            modelBuilder.Entity("grp_management.Models.SentMsg", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            SenderEmployeeId = -1,
                            SentDate = new DateTime(2025, 6, 21, 10, 12, 20, 733, DateTimeKind.Utc).AddTicks(3193),
                            SentVia = "WebApp",
                            Status = "Sent",
                            TemplateID = -1,
                            VariablesJson = "{}"
                        ...
                        new
                        {
                            ...
                            SenderEmployeeId = -2,
                            SentDate = new DateTime(2025, 6, 21, 15, 12, 20, 733, DateTimeKind.Utc).AddTicks(3225),
                            SentVia = "WebApp",
                            Status = "Sent",
                            TemplateID = -2,
                            VariablesJson = "{}"
            ...
            modelBuilder.Entity("grp_management.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = -1,
                            CreatedAt = new DateTime(2025, 6, 21, 20, 12, 20, 245, DateTimeKind.Utc).AddTicks(3832),
                            Email = "admin@example.com",
                            PasswordHash = "$2a$12$YKGAk73u8fGBvR0UxUXulu7vMBNFx.bQ5LLy0kJ8gweWLMfFsZgZC",
                            Role = "Admin",
                            Username = "admin"
                        },
                        new
                        {
                            Id = -2,
                            CreatedAt = new DateTime(2025, 6, 21, 20, 12, 20, 733, DateTimeKind.Utc).AddTicks(552),
                            Email = "user@example.com",
                            PasswordHash = "$2a$12$lA02SuNwzu/8BuV2dE.97uJpkUPcr9VJvPggsoxPpL.VJZpmLOb5y",
                            Role = "User",
                            Username = "user"
                        });
                });
